	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="Bank Deposit"><!--?php echo LANG_VALUE_38; ?!-->QR CODE</option>
	                                    </select>
	                                </div>
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label for="Enter your Mobile Number"> Enter Your Mobile Number</lable>
                                            <!--label for=""><?php echo LANG_VALUE_44; ?> <br><span style="font-size:12px;font-weight:normal;"><?php echo LANG_VALUE_45; ?></span></label!-->
                                            <input type="number" name="transaction_info" class="form-control" cols="2" rows="2"></input>
