        ...
        <div class="row">
            <?php
                ...
                foreach ($result as $row) {
                    ...
                    <div class="col-md-4">
                        <div class="item">
                            <div class="photo"><img src="assets/uploads/<?php echo $row['photo']; ?>" alt="<?php echo $row['title']; ?>" width="100" height="100"></div>
            ...
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            <div class="thumb">
                                  <div class="photo"><img src="assets/uploads/<?php echo $row['p_featured_photo']; ?>" alt="<?php echo $row['title']; ?>" ></div>
                                <div class="photo" style="background-image:url(assets/uploads/<!?php echo $row['p_featured_photo']; ?>);"></div!>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
